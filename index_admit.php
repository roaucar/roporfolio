...
<div class="p-5 bg-light">
    <div class="container">
        ...
        <hr class="my-2">
        <p class="lead" style="font-size:1.5rem;">En abm podra:  <br> Dar de alta un nuevo proyecto <br> Dar de baja un proyecto <br> Modificar un proyecto <br>
        Cualquier duda <a href="mailto:roalvarezaucar@gmail.com">Click para enviar email</a></p>
